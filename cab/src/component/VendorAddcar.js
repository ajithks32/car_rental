...
const VendorAddcar = ({ onTaxiAdded }) => {
   ...
   <div className="taxi-banner">
      <img src={bg} alt="Background" className="pay-banner-img" />
           <div className="taxi-overlay">
             <h1 className="taxi-title">Add Car</h1>
           </div>
         </div>
    <div className="add-car-container">
      <form onSubmit={handleSubmit} className="taxi-form add-car-form">
        ...
        <button type="submit" className="taxi-submit-btn">Add Taxi</button>
      </form>
      <ToastContainer />
    </div>
    </>
